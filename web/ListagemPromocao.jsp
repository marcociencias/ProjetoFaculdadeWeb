...
<div class="container">
<h1><strong>TELA PARA INSERIR PRODUTOS PARA PROMOÇÃO</strong></h1>
...
<tr>
    ...
    <td><a href=ProdutoServlet?action=Promocao&cod=<%= produto.getCod() %>&desconto=10><img src="Photo/Desconto.png" width="50" height="50"></a></td>
    <td><a href=ProdutoServlet?action=Promocao&cod=<%= produto.getCod() %>&desconto=20><img src="Photo/Desconto.png" width="50" height="50"</a></td>
    <td><a href=ProdutoServlet?action=Promocao&cod=<%= produto.getCod() %>&desconto=30><img src="Photo/Desconto.png" width="50" height="50"</a></td>
</tr>
    <%
}   
%>
...
<p><button><a href="TelaAdministrador.jsp" type="button" border-radius:15px>Retornar</a></button></p>
</form>
</center>
</body>
</html>
